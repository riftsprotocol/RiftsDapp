...
export const GOVERNANCE_PROGRAM_ID = new PublicKey("89v8sYZWr6TDsAQWcAWR18tEphTQQxjciJkr9t8hDmb1");
...
export class GovernanceService {
    ...
    async createProposal(
        ...
        proposalIdBuffer.writeBigUInt64LE(BigInt(nextProposalId), 0);
...
export const governanceService = new GovernanceService(
    new Connection(process.env.NEXT_PUBLIC_SOLANA_RPC_URL!, 'confirmed')
);