...
export const RIFTS_PROGRAM_ID = new PublicKey('D37XSobyWYs1XHUjF4YopMuPPYQ6GYCSjJCyPmat3CLn'); // ✅ FIXED DEPLOYMENT
export const RIFTS_TOKEN_MINT = new PublicKey('DqUFchBMxdqcYHQbaJqZHVDNz1PfMBQzLYFUze37uPnn');

// Fee constants (in basis points)
export const WRAP_FEE_BPS = 70; // 0.7%
export const UNWRAP_FEE_BPS = 70; // 0.7%
export const MAX_BURN_FEE_BPS = 4500; // 45%
export const MAX_PARTNER_FEE_BPS = 500; // 5%
